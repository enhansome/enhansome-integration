...
* [LiteLLM (⭐57k)](https://github.com/BerriAI/litellm) ⭐ 58,377 | 🐛 5,015 | 🌐 Python | 📅 2026-09-09 - An LLM gateway that exposes 100+ model providers through a unified OpenAI-compatible API, with spend tracking, fallbacks, and rate limiting.
* [Portkey AI Gateway (⭐12k)](https://github.com/Portkey-AI/gateway) ⭐ 12,945 | 🐛 259 | 🌐 TypeScript | 📅 2026-05-25 - A fast AI gateway that routes to 250+ LLMs with guardrails, caching, retries, and load balancing via a single API.
* [Bifrost (⭐7.7k)](https://github.com/maximhq/bifrost) ⭐ 7,924 | 🐛 998 | 🌐 Go | 📅 2026-09-09 - A high-performance AI gateway written in Go that unifies more than 20 model providers behind a single OpenAI-compatible API, with failover, load balancing, semantic caching, and governance.
* [agentgateway (⭐4.6k)](https://github.com/agentgateway/agentgateway) ⭐ 4,776 | 🐛 281 | 🌐 Rust | 📅 2026-09-09 - An open-source data plane for agentic AI connectivity, providing security, observability, and governance for agent-to-tool (MCP) and agent-to-agent (A2A) communication.
* [IBM ContextForge (⭐4.3k)](https://github.com/IBM/mcp-context-forge) ⭐ 4,449 | 🐛 868 | 🌐 Python | 📅 2026-09-09 - An AI gateway, registry, and proxy that federates MCP, A2A, and REST services behind a single endpoint with governance and observability.
* [Envoy AI Gateway (⭐1.9k)](https://github.com/envoyproxy/ai-gateway) ⭐ 2,010 | 🐛 277 | 🌐 Go | 📅 2026-09-09 - An open-source gateway built on Envoy Proxy to manage request traffic from application clients to GenAI services with unified API access and usage limits.
* [Docker MCP Gateway (⭐1.5k)](https://github.com/docker/mcp-gateway) ⭐ 1,558 | 🐛 136 | 🌐 Go | 📅 2026-08-26 - Runs MCP servers as isolated containers with restricted privileges and managed secrets, exposing them to AI clients through one gateway endpoint.
* [MCPJungle (⭐1.2k)](https://github.com/mcpjungle/MCPJungle) ⭐ 1,248 | 🐛 105 | 🌐 Go | 📅 2026-08-02 - A self-hosted MCP gateway and registry that centralises multiple MCP servers behind one endpoint for AI agents.
* [Obot (⭐971)](https://github.com/obot-platform/obot) ⭐ 991 | 🐛 411 | 🌐 Go | 📅 2026-09-09 - An open-source MCP platform that combines server hosting, a registry, a gateway, and a chat client with access control and audit logging.
...
* [WSO2 API Manager (⭐1k)](https://github.com/wso2/product-apim) ⭐ 1,027 | 🐛 651 | 🌐 Java | 📅 2026-09-09 - A fully open-source API platform offering robust governance, flexible deployment, and community-driven innovation.
* [Gravitee.io API Management (⭐447)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 451 | 🐛 83 | 🌐 Java | 📅 2026-09-09 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐26k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,734 | 🐛 5,755 | 🌐 Java | 📅 2026-09-09 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
* [Swagger Editor (⭐9.4k)](https://github.com/swagger-api/swagger-editor) ⭐ 9,461 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-08 - Create, describe, and document your API with ease using this open source editor built specifically for OpenAPI-based APIs.
...
* [Kiota (⭐3.8k)](https://github.com/microsoft/kiota) ⭐ 3,819 | 🐛 225 | 🌐 C# | 📅 2026-09-09 - A command-line generator from Microsoft that turns an OpenAPI description into a lightweight, strongly typed API client in many languages.
* [Spectral (⭐3.1k)](https://github.com/stoplightio/spectral) ⭐ 3,205 | 🐛 224 | 🌐 TypeScript | 📅 2026-09-09 - Detect and fix errors in your JSON/YAML files using this linter tool that supports OpenAPI 3.0 & 2.0 and AsyncAPI.
* [Redocly CLI (⭐1.5k)](https://github.com/Redocly/redocly-cli) ⭐ 1,510 | 🐛 166 | 🌐 TypeScript | 📅 2026-09-09 - Lint, bundle, and preview OpenAPI descriptions with configurable rulesets and plugins.
...
* [oasdiff (⭐1.3k)](https://github.com/oasdiff/oasdiff) ⭐ 1,356 | 🐛 47 | 🌐 Go | 📅 2026-09-09 - Compare OpenAPI specs and detect breaking changes, with changelog generation in multiple output formats.
* [vacuum (⭐1.1k)](https://github.com/daveshanley/vacuum) ⭐ 1,124 | 🐛 40 | 🌐 Go | 📅 2026-09-02 - An ultra-fast OpenAPI linter and quality analysis tool, compatible with Spectral rulesets.
* [OpenAPI Diff (⭐1k)](https://github.com/OpenAPITools/openapi-diff) ⭐ 1,096 | 🐛 84 | 🌐 Java | 📅 2026-09-04 - Compare OpenAPI specs with version control and visualize the differences in HTML or Markdown format.
...
* [Zally (⭐946)](https://github.com/zalando/zally) ⭐ 946 | 🐛 102 | 🌐 Kotlin | 📅 2026-07-08 - Ensure the quality of your OpenAPI specs with this linter tool that provides extensive analysis and feedback.
...
* [Swagger UI (⭐28k)](https://github.com/swagger-api/swagger-ui) ⭐ 29,002 | 🐛 1,130 | 🌐 JavaScript | 📅 2026-09-07 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,903 | 🐛 451 | 🌐 TypeScript | 📅 2026-09-09 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
* [Scalar (⭐16k)](https://github.com/scalar/scalar) ⭐ 16,088 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-09 - Renders modern, interactive API references from OpenAPI/Swagger documents, with an integrated API client and broad framework integrations.
* [Fern (⭐3.7k)](https://github.com/fern-api/fern) ⭐ 3,775 | 🐛 345 | 🌐 TypeScript | 📅 2026-09-09 - Generates SDKs and interactive API documentation from OpenAPI or its own API definition format.
* [Stoplight Elements (⭐2.4k)](https://github.com/stoplightio/elements) ⭐ 2,457 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-09 - Provides modular, attractive UI components for building comprehensive API reference and tutorial documentation.
...
* [Zudoku (⭐585)](https://github.com/zuplo/zudoku) ⭐ 591 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-04 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐64k)](https://github.com/traefik/traefik) ⭐ 64,792 | 🐛 920 | 🌐 Go | 📅 2026-09-09 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐44k)](https://github.com/Kong/kong) ⭐ 44,112 | 🐛 194 | 🌐 Lua | 📅 2026-09-07 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐17k)](https://github.com/apache/apisix) ⭐ 17,102 | 🐛 238 | 🌐 Lua | 📅 2026-09-09 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,820 | 🐛 505 | 🌐 Go | 📅 2026-09-09 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
* [Higress (⭐9.2k)](https://github.com/higress-group/higress) ⭐ 9,335 | 🐛 1,099 | 🌐 Go | 📅 2026-09-08 - A next-generation cloud-native gateway based on Envoy and Istio, offering high performance, easy-to-use, and rich plugin extensibility.
* [Apache ShenYu (⭐8.8k)](https://github.com/apache/shenyu) ⭐ 8,830 | 🐛 565 | 🌐 Java | 📅 2026-09-07 - A Java-native gateway excelling in protocol conversion, service proxying, and comprehensive API governance.
* [Ocelot (⭐8.7k)](https://github.com/ThreeMammals/Ocelot) ⭐ 8,714 | 🐛 57 | 🌐 C# | 📅 2026-09-03 - A .NET-based gateway offering intuitive routing and easy integration for lightweight API management.
* [kgateway (⭐5.6k)](https://github.com/kgateway-dev/kgateway) ⭐ 5,684 | 🐛 224 | 🌐 Go | 📅 2026-09-09 - A CNCF Envoy-based, Kubernetes-native API gateway built around the Kubernetes Gateway API, and the successor to the Gloo open-source project.
* [Spring Cloud Gateway (⭐4.9k)](https://github.com/spring-cloud/spring-cloud-gateway) ⭐ 4,905 | 🐛 545 | 🌐 Java | 📅 2026-09-08 - Leverages the Spring ecosystem to deliver robust routing, filtering, and security for microservices.
* [Envoy Gateway (⭐3k)](https://github.com/envoyproxy/gateway) ⭐ 3,024 | 🐛 773 | 🌐 Go | 📅 2026-09-09 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
* [KrakenD API Gateway (⭐2.6k)](https://github.com/krakend/krakend-ce) ⭐ 2,676 | 🐛 37 | 🌐 Go | 📅 2026-09-09 - An ultra-high performance gateway with efficient middleware configuration, robust security, and seamless scaling.
* [Apinto (⭐1.6k)](https://github.com/eolinker/apinto) ⭐ 1,676 | 🐛 46 | 🌐 Go | 📅 2026-09-09 - A Golang-based gateway that offers dynamic routing, multi-tenancy, and robust API access control for modern architectures.
...
* API clients
  * [Hoppscotch (⭐80k)](https://github.com/hoppscotch/hoppscotch) ⭐ 80,259 | 🐛 819 | 🌐 TypeScript | 📅 2026-09-08 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐46k)](https://github.com/usebruno/bruno) ⭐ 46,851 | 🐛 1,826 | 🌐 JavaScript | 📅 2026-09-09 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐42k)](https://github.com/curl/curl) ⭐ 42,815 | 🐛 43 | 🌐 C | 📅 2026-09-09 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐39k)](https://github.com/Kong/insomnia) ⭐ 40,001 | 🐛 874 | 🌐 TypeScript | 📅 2026-09-09 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  * [HTTPie (⭐38k)](https://github.com/httpie/httpie) ⭐ 38,489 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
  * [Yaak (⭐19k)](https://github.com/mountain-loop/yaak) ⭐ 19,182 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-09 - A fast, privacy-first desktop API client for REST, GraphQL, WebSocket, Server-Sent Events, and gRPC with offline-first design, built with Tauri and React.
  * [grpcurl (⭐12k)](https://github.com/fullstorydev/grpcurl) ⭐ 12,804 | 🐛 121 | 🌐 Go | 📅 2026-09-02 - A command-line tool for interacting with gRPC servers, enabling inspection and invocation of RPC methods with support for server reflection and protocol buffer files.
  * [posting (⭐12k)](https://github.com/darrenburns/posting) ⭐ 12,385 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [xh (⭐8k)](https://github.com/ducaale/xh) ⭐ 8,064 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - A fast, friendly CLI HTTP client that reimplements HTTPie's design with improved performance, HTTP/2 support, and built-in curl translation.
  * [Requestly (⭐6.7k)](https://github.com/requestly/requestly) ⭐ 6,755 | 🐛 274 | 📅 2026-09-09 - Lightweight Git-Friendly API Client Built for Modern Developers.
  * [gRPC UI (⭐5.9k)](https://github.com/fullstorydev/grpcui) ⭐ 5,924 | 🐛 78 | 🌐 JavaScript | 📅 2026-09-08 - An interactive web-based tool for gRPC APIs, providing a browser-based interface for testing and exploring gRPC services with dynamic form generation.
  * [curlie (⭐3.7k)](https://github.com/rs/curlie) ⭐ 3,717 | 🐛 26 | 🌐 Go | 📅 2025-12-07 - A modern, user-friendly frontend to curl that combines simplicity with powerful performance.
  * [resty (⭐2.6k)](https://github.com/micha/resty) ⭐ 2,654 | 🐛 17 | 🌐 Shell | 📅 2023-02-17 - A tiny command-line REST client implemented as shell functions around curl, handy for quick API exploration from the terminal.
  * [Yaade (⭐1.9k)](https://github.com/EsperoTech/yaade) ⭐ 1,989 | 🐛 58 | 🌐 JavaScript | 📅 2025-09-08 - A self-hosted, collaborative API development environment designed for team sharing with multi-user support, persistent storage, and support for REST, WebSockets, and Markdown documentation.
...
* Contract testing
  ...
  * [Specmatic (⭐396)](https://github.com/specmatic/specmatic) ⭐ 396 | 🐛 76 | 🌐 Kotlin | 📅 2026-09-09 - Turns OpenAPI, AsyncAPI, and gRPC specifications into executable contracts for contract-driven development and testing.
...
* MQ clients
  * [kcat (⭐5.7k)](https://github.com/edenhill/kcat) ⭐ 5,781 | 🐛 162 | 🌐 C | 📅 2024-07-09 - A lightweight command-line tool for Apache Kafka (formerly named kafkacat), providing efficient message production and consumption.
  * [MQTT Explorer (⭐4k)](https://github.com/thomasnordquist/MQTT-Explorer) ⭐ 4,057 | 🐛 397 | 🌐 TypeScript | 📅 2026-05-08 - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
  * [Service Bus Explorer (⭐2.2k)](https://github.com/paolosalvatori/ServiceBusExplorer) ⭐ 2,215 | 🐛 74 | 🌐 C# | 📅 2026-09-09 - An advanced GUI for Azure Service Bus that enables in-depth testing and seamless management of topics, queues, and subscriptions.
  * [JMSToolBox (⭐234)](https://github.com/jmstoolbox/jmstoolbox) ⭐ 234 | 🐛 39 | 🌐 Java | 📅 2026-09-09 - A universal JMS client offering broad compatibility and streamlined messaging testing across various brokers.
...
* Mocking tools
  * [Mock Service Worker (MSW) (⭐18k)](https://github.com/mswjs/msw) ⭐ 18,198 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-08 - A seamless API mocking library for browser and Node.js that intercepts requests at the network level.
  * [Mockoon (⭐8.3k)](https://github.com/mockoon/mockoon) ⭐ 8,394 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-09 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.3k)](https://github.com/wiremock/wiremock) ⭐ 7,365 | 🐛 503 | 🌐 Java | 📅 2026-09-08 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  * [Prism (⭐5k)](https://github.com/stoplightio/prism) ⭐ 5,027 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-03 - An open-source HTTP mock server that replicates API behavior for early testing and validation.
  * [MockServer (⭐4.9k)](https://github.com/mock-server/mockserver) ⭐ 4,968 | 🐛 0 | 🌐 Java | 📅 2026-09-09 - A powerful solution for mocking any HTTP/HTTPS-based service, streamlining integration testing.
  * [Hoverfly (⭐2.5k)](https://github.com/SpectoLabs/hoverfly) ⭐ 2,513 | 🐛 34 | 🌐 Go | 📅 2026-09-07 - A lightweight API simulation tool that enables rapid HTTP(S) service virtualization for efficient testing.
  ...
  * [Microcks (⭐2k)](https://github.com/microcks/microcks) ⭐ 2,037 | 🐛 60 | 🌐 Java | 📅 2026-09-09 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
  ...
  * [Mockbin (⭐144)](https://github.com/zuplo/mockbin) ⭐ 144 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-08 - A simple endpoint generator for testing HTTP requests with real-time logging and feedback.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐31k)](https://github.com/grafana/k6) ⭐ 31,424 | 🐛 815 | 🌐 Go | 📅 2026-09-09 - Open-source, JS-scriptable load-testing tool for CI/CD.
  * [Hurl (⭐19k)](https://github.com/Orange-OpenSource/hurl) ⭐ 19,189 | 🐛 206 | 🌐 Rust | 📅 2026-09-09 - A command-line tool for running HTTP requests with plain text syntax, excellent for both API testing and CI/CD integration with support for chaining, capturing values, and comprehensive assertions.
  * [Keploy (⭐18k)](https://github.com/keploy/keploy) ⭐ 18,447 | 🐛 727 | 🌐 Go | 📅 2026-09-09 - A developer-centric API and integration testing tool that auto-generates tests and data-mocks from real traffic using eBPF, supporting any language without code changes.
  * [Apache JMeter (⭐9.5k)](https://github.com/apache/jmeter) ⭐ 9,527 | 🐛 976 | 🌐 Java | 📅 2026-09-06 - A feature-rich tool for load testing and performance analysis across diverse web applications and services.
  * [Artillery (⭐9k)](https://github.com/artilleryio/artillery) ⭐ 9,072 | 🐛 486 | 🌐 TypeScript | 📅 2026-08-26 - A complete load testing platform supporting HTTP, WebSocket, Socket.io, gRPC, and more, with cloud-native serverless scaling on AWS Lambda and Fargate.
  * [Karate (⭐8.9k)](https://github.com/karatelabs/karate) ⭐ 8,950 | 🐛 16 | 🌐 Java | 📅 2026-09-05 - A unified testing framework that merges API automation, mocking, and performance testing with simple, expressive syntax.
  * [REST Assured (⭐7.1k)](https://github.com/rest-assured/rest-assured) ⭐ 7,140 | 🐛 596 | 🌐 Java | 📅 2026-07-22 - A Java DSL that simplifies REST API testing with intuitive syntax and seamless integration into CI pipelines.
  * [Gatling (⭐6.9k)](https://github.com/gatling/gatling) ⭐ 6,956 | 🐛 19 | 🌐 Scala | 📅 2026-09-07 - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
  * [Schemathesis (⭐3.5k)](https://github.com/schemathesis/schemathesis) ⭐ 3,590 | 🐛 10 | 🌐 Python | 📅 2026-09-09 - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
  * [ghz (⭐3.3k)](https://github.com/bojand/ghz) ⭐ 3,354 | 🐛 101 | 🌐 Go | 📅 2026-09-01 - A simple gRPC benchmarking and load testing tool with support for various load schedules, concurrency control, and detailed performance metrics.
  * [RESTler (⭐2.9k)](https://github.com/microsoft/restler-fuzzer) ⭐ 2,942 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - A stateful REST API fuzzing tool that automatically discovers security and reliability bugs by intelligently inferring producer-consumer dependencies from OpenAPI specifications.
  * [Taurus (⭐2.1k)](https://github.com/Blazemeter/taurus) ⭐ 2,112 | 🐛 39 | 🌐 Python | 📅 2026-09-07 - An open-source automation framework that simplifies continuous testing with intuitive configuration and integration support.
...
* [Smooks (⭐418)](https://github.com/smooks/smooks) ⭐ 419 | 🐛 35 | 🌐 Java | 📅 2025-11-24 - Extensible Java framework for processing and transforming structured data such as EDI, XML, CSV, and JSON.
* [OpenAS2 (⭐235)](https://github.com/OpenAS2/OpenAs2App) ⭐ 236 | 🐛 9 | 🌐 Java | 📅 2026-09-08 - Java-based open-source implementation of the AS2 protocol for secure, signed, and encrypted document exchange over HTTP.
* [phase4 (⭐235)](https://github.com/phax/phase4) ⭐ 236 | 🐛 5 | 🌐 Java | 📅 2026-09-06 - Embeddable, lightweight Java library implementing the AS4 messaging protocol, including the Peppol and CEF/eDelivery profiles.
...
* [Drools (⭐6.3k)](https://github.com/apache/incubator-kie-drools) ⭐ 6,314 | 🐛 285 | 🌐 Java | 📅 2026-09-09 - Open-source engine that supports advanced Decision Model and Notation (DMN) with Eclipse IDE integration for efficient rule development.
* [ZEN Engine (⭐1.9k)](https://github.com/gorules/zen) ⭐ 1,968 | 🐛 41 | 🌐 Rust | 📅 2026-08-25 - A cross-platform, open-source Business Rules Engine written in Rust that executes JSON Decision Models through interconnected graphs of decision tables, functions, and expressions.
* [OpenL Tablets (⭐204)](https://github.com/openl-tablets/openl-tablets) ⭐ 205 | 🐛 27 | 🌐 Java | 📅 2026-09-09 - Flexible open-source decision management system that simplifies defining and executing business rules and decision tables.
...
* [Debezium (⭐13k)](https://github.com/debezium/debezium) ⭐ 13,101 | 🐛 130 | 🌐 Java | 📅 2026-09-09 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
...
* [PeerDB (⭐3.2k)](https://github.com/PeerDB-io/peerdb) ⭐ 3,265 | 🐛 197 | 🌐 Go | 📅 2026-09-09 - Postgres-first CDC platform for fast, simple replication from PostgreSQL to data warehouses, queues, and storage.
* [Sequin (⭐2.1k)](https://github.com/sequinstream/sequin) ⭐ 2,198 | 🐛 71 | 🌐 Elixir | 📅 2026-02-23 - PostgreSQL change data capture platform that streams row-level changes to Kafka, SQS, Redis, NATS, RabbitMQ, HTTP endpoints, and search indexes with exactly-once processing.
...
* [Airbyte (⭐21k)](https://github.com/airbytehq/airbyte) ⭐ 22,021 | 🐛 2,392 | 🌐 Python | 📅 2026-09-09 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Apache SeaTunnel (⭐9.6k)](https://github.com/apache/seatunnel) ⭐ 9,628 | 🐛 733 | 🌐 Java | 📅 2026-09-09 - High-performance, distributed data integration platform supporting batch and streaming synchronization across hundreds of connectors.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,387 | 🐛 81 | 🌐 Java | 📅 2026-09-09 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐6.2k)](https://github.com/apache/nifi) ⭐ 6,225 | 🐛 41 | 🌐 Java | 📅 2026-09-09 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
* [dlt (⭐5.8k)](https://github.com/dlt-hub/dlt) ⭐ 5,837 | 🐛 427 | 🌐 Python | 📅 2026-09-09 - Open-source Python library for building data pipelines as code, with schema evolution and incremental loading out of the box.
* [Meltano (⭐2.6k)](https://github.com/meltano/meltano) ⭐ 2,620 | 🐛 145 | 🌐 Python | 📅 2026-09-09 - Declarative, code-first data integration engine that runs Singer taps and targets with version-controlled pipeline configuration.
* [Apache InLong (⭐1.4k)](https://github.com/apache/inlong) ⭐ 1,498 | 🐛 23 | 🌐 Java | 📅 2026-09-08 - One-stop, full-scenario integration framework for massive data that supports data ingestion, synchronization, and subscription with real-time ETL capabilities.
* [Singer (⭐1.3k)](https://github.com/singer-io/getting-started) ⭐ 1,348 | 🐛 29 | 🌐 Makefile | 📅 2025-08-08 - Open-source standard for writing scripts that move data, defining a JSON-based protocol between extraction "taps" and loading "targets".
* [Estuary Flow (⭐966)](https://github.com/estuary/flow) ⭐ 973 | 🐛 248 | 🌐 Rust | 📅 2026-09-09 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
* [Sling (⭐896)](https://github.com/slingdata-io/sling-cli) ⭐ 899 | 🐛 38 | 🌐 Go | 📅 2026-09-09 - Fast ELT command-line tool and Go library for moving data between databases, files, and cloud storage across a wide set of connectors.
* [Conduit (⭐608)](https://github.com/ConduitIO/conduit) ⭐ 609 | 🐛 122 | 🌐 Go | 📅 2026-09-09 - Lightweight data integration tool written in Go that streams data between systems using built-in or standalone connectors, with Kafka Connect compatibility.
...
* [JSONata (⭐2.6k)](https://github.com/jsonata-js/jsonata) ⭐ 2,687 | 🐛 173 | 🌐 JavaScript | 📅 2026-07-30 - Lightweight query and transformation language for JSON data.
...
* [JSLT (⭐699)](https://github.com/schibsted/jslt) ⭐ 701 | 🐛 120 | 🌐 Java | 📅 2026-07-14 - Powerful JSON query and transformation language inspired by jq and XPath, designed for rapid and flexible data manipulation.
...
* [Kaoto (⭐125)](https://github.com/KaotoIO/kaoto) ⭐ 125 | 🐛 248 | 🌐 TypeScript | 📅 2026-09-09 - Visual data mapper for Apache Camel with a drag-and-drop interface supporting XML, JSON, CSV, and XSLT transformations. Successor to AtlasMap.
...
* [NServiceBus (⭐2.1k)](https://github.com/Particular/NServiceBus) ⭐ 2,169 | 🐛 292 | 🌐 C# | 📅 2026-09-09 - Developer-friendly, .NET-based service bus that simplifies messaging and orchestrates service integration efficiently.
* [WSO2 Integrator: MI (⭐260)](https://github.com/wso2/product-integrator-mi) ⭐ 262 | 🐛 375 | 🌐 Java | 📅 2026-09-08 - The configuration-driven integration runtime of the WSO2 Integrator platform, supporting enterprise integration patterns in centralised and containerised deployments.
...
* [MassTransit (⭐7.7k)](https://github.com/MassTransit/MassTransit) ⭐ 7,800 | 🐛 1 | 🌐 C# | 📅 2026-06-04 - Distributed application framework for .NET that provides a consistent messaging abstraction on top of transports such as RabbitMQ, Azure Service Bus, and Amazon SQS.
* [Apache Camel (⭐6.3k)](https://github.com/apache/camel) ⭐ 6,314 | 🐛 40 | 🌐 Java | 📅 2026-09-09 - Integration framework with 300+ connectors for databases, messaging, APIs, cloud services, and enterprise systems. Supports both Spring Boot and Quarkus runtimes, and includes AI agent interoperability via the A2A and MCP protocols.
* [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,850 | 🐛 1,613 | 🌐 Ballerina | 📅 2026-09-03 - Innovative programming language designed for effortless creation and integration of network services and APIs.
* [Wolverine (⭐2.3k)](https://github.com/JasperFx/wolverine) ⭐ 2,335 | 🐛 29 | 🌐 C# | 📅 2026-09-09 - Low-ceremony messaging and command-bus framework for .NET with built-in durable messaging and transports like RabbitMQ and Kafka.
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,628 | 🐛 90 | 🌐 Java | 📅 2026-09-08 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
* [Spring Cloud Stream (⭐1k)](https://github.com/spring-cloud/spring-cloud-stream) ⭐ 1,070 | 🐛 129 | 🌐 Java | 📅 2026-09-08 - Framework for building event-driven microservices connected to shared messaging systems through binder abstractions for Kafka, RabbitMQ, and more.
* [Frank!Framework (⭐165)](https://github.com/frankframework/frankframework) ⭐ 165 | 🐛 239 | 🌐 Java | 📅 2026-09-09 - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
...
* [Camel K (⭐927)](https://github.com/apache/camel-k) ⭐ 928 | 🐛 60 | 🌐 Go | 📅 2026-09-09 - Lightweight Kubernetes-native integration platform built on Apache Camel that runs integration routes directly on Kubernetes and OpenShift as cloud-native serverless services.
...
* [Apache Kafka (⭐33k)](https://github.com/apache/kafka) ⭐ 33,695 | 🐛 557 | 🌐 Java | 📅 2026-09-09 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
* [NSQ (⭐25k)](https://github.com/nsqio/nsq) ⭐ 25,777 | 🐛 78 | 🌐 Go | 📅 2026-08-11 - Realtime distributed messaging platform designed to operate at scale, handling billions of messages per day with decentralized topology.
* [Apache RocketMQ (⭐22k)](https://github.com/apache/rocketmq) ⭐ 22,586 | 🐛 659 | 🌐 Java | 📅 2026-09-09 - High-performance distributed messaging platform engineered for low latency and high throughput.
* [NATS (⭐20k)](https://github.com/nats-io/nats-server) ⭐ 20,687 | 🐛 532 | 🌐 Go | 📅 2026-09-09 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐16k)](https://github.com/emqx/emqx) ⭐ 16,701 | 🐛 188 | 🌐 Erlang | 📅 2026-09-09 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
* [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) ⭐ 15,326 | 🐛 1,755 | 🌐 Java | 📅 2026-09-09 - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,849 | 🐛 256 | 🌐 JavaScript | 📅 2026-09-09 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐12k)](https://github.com/redpanda-data/redpanda) ⭐ 12,528 | 🐛 531 | 🌐 C++ | 📅 2026-08-22 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐11k)](https://github.com/eclipse-mosquitto/mosquitto) ⭐ 11,187 | 🐛 881 | 🌐 C | 📅 2026-09-03 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
* [ZeroMQ (⭐10k)](https://github.com/zeromq/libzmq) ⭐ 10,989 | 🐛 382 | 🌐 C++ | 📅 2026-07-26 - High-performance asynchronous messaging library providing broker-less, socket-based messaging patterns for distributed applications.
* [Centrifugo (⭐10k)](https://github.com/centrifugal/centrifugo) ⭐ 10,731 | 🐛 23 | 🌐 Go | 📅 2026-09-07 - Scalable real-time messaging server that minimizes delay in delivering events to online users.
* [AutoMQ (⭐10k)](https://github.com/AutoMQ/automq) ⭐ 10,679 | 🐛 60 | 🌐 Java | 📅 2026-09-09 - Stateless, Kafka-compatible broker that runs on S3-class object storage for elastic scaling and reduced cost.
* [Apache Iggy (⭐4.7k)](https://github.com/apache/iggy) ⭐ 4,839 | 🐛 181 | 🌐 Rust | 📅 2026-09-09 - Persistent message streaming platform written in Rust, supporting QUIC, TCP, and HTTP transports with high throughput and low latency.
* [VerneMQ (⭐3.6k)](https://github.com/vernemq/vernemq) ⭐ 3,628 | 🐛 172 | 🌐 Erlang | 📅 2026-09-04 - High-performance distributed MQTT broker designed for scalable and efficient message delivery in modern environments.
* [BlazingMQ (⭐3.2k)](https://github.com/bloomberg/blazingmq) ⭐ 3,213 | 🐛 101 | 🌐 C++ | 📅 2026-09-09 - Distributed message queuing system focused on efficiency and reliability for modern workflow needs.
* [ElasticMQ (⭐2.9k)](https://github.com/softwaremill/elasticmq) ⭐ 2,928 | 🐛 22 | 🌐 Scala | 📅 2026-09-08 - In-memory message queue with an Amazon SQS-compatible interface, offering stand-alone or embedded deployment with optional UI and queue persistence.
* [Magistrala (⭐2.6k)](https://github.com/absmach/magistrala) ⭐ 2,631 | 🐛 229 | 🌐 Go | 📅 2026-09-07 - Distributed, event-driven infrastructure for messaging supporting multiple protocols (HTTP, MQTT, WebSocket, CoAP) with strong security and IoT capabilities.
* [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) ⭐ 2,457 | 🐛 91 | 🌐 Java | 📅 2026-09-09 - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
* [Apache EventMesh (⭐1.7k)](https://github.com/apache/eventmesh) ⭐ 1,754 | 🐛 251 | 🌐 Java | 📅 2026-09-09 - A dynamic event-driven application runtime that acts as a serverless event middleware for decoupling applications and backend brokers.
* [RMQ (⭐1.6k)](https://github.com/wellle/rmq) ⭐ 1,618 | 🐛 4 | 🌐 Go | 📅 2024-12-13 - Redis-backed message queue written in Go, providing flexible queue management, batch consumers, and efficient delivery patterns.
* [HiveMQ (⭐1.2k)](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,208 | 🐛 27 | 🌐 Java | 📅 2026-09-08 - MQTT broker built for reliable IoT messaging at scale, with an open-source community edition and a rich extension system.
* [Apache ActiveMQ Artemis (⭐1k)](https://github.com/apache/activemq-artemis) ⭐ 1,040 | 🐛 25 | 🌐 Java | 📅 2026-09-09 - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
* [LavinMQ (⭐1k)](https://github.com/cloudamqp/lavinmq) ⭐ 1,007 | 🐛 166 | 🌐 Crystal | 📅 2026-09-09 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
* [Apache Qpid (⭐71)](https://github.com/apache/qpid-broker-j) ⭐ 71 | 🐛 5 | 🌐 Java | 📅 2026-09-09 - AMQP-compliant messaging tool with multi-language support for enterprise-grade message delivery.
...
* [Robot Framework (⭐11k)](https://github.com/robotframework/robotframework) ⭐ 11,873 | 🐛 299 | 🌐 Python | 📅 2026-09-09 - An open-source automation framework with human-friendly keyword syntax that enables both technical and non-technical users to create test scripts and automate business processes cost-effectively, supporting web, API, mobile, and database automation through extensive libraries and integrations.
* [TagUI (⭐6.3k)](https://github.com/aisingapore/TagUI) ⭐ 6,328 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-21 - An open-source RPA tool that democratizes automation through natural language scripting in 20+ human languages, enabling non-programmers to automate web, desktop, and data tasks while integrating AI/ML capabilities via Python and R for intelligent process automation.
* [OpenRPA (⭐3k)](https://github.com/open-rpa/openrpa) ⭐ 3,059 | 🐛 2 | 🌐 C# | 📅 2026-04-15 - Enterprise-grade, open-source robotic process automation suite.
...
* [Confluent Schema Registry (⭐2.4k)](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 392 | 🌐 Java | 📅 2026-09-09 - Widely used registry for Kafka, providing a RESTful interface and compatibility checks for Avro, JSON Schema, and Protobuf schemas.
* [Apicurio Registry (⭐925)](https://github.com/Apicurio/apicurio-registry) ⭐ 931 | 🐛 669 | 🌐 Java | 📅 2026-09-09 - Open-source registry for API designs and schemas, supporting Avro, Protobuf, JSON Schema, OpenAPI, and AsyncAPI artifacts with configurable compatibility rules.
* [Karapace (⭐632)](https://github.com/Aiven-Open/karapace) ⭐ 634 | 🐛 93 | 🌐 Python | 📅 2026-09-04 - Open-source, drop-in replacement for Confluent Schema Registry and the Kafka REST API.
...
* [n8n (⭐202k)](https://github.com/n8n-io/n8n) ⭐ 203,857 | 🐛 1,151 | 🌐 TypeScript | 📅 2026-09-09 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
* [Huginn (⭐49k)](https://github.com/huginn/huginn) ⭐ 49,921 | 🐛 693 | 🌐 Ruby | 📅 2026-09-08 - Self-hosted system for building agents that monitor services and act on your behalf, like a hackable version of IFTTT.
* [Activepieces (⭐24k)](https://github.com/activepieces/activepieces) ⭐ 24,368 | 🐛 548 | 🌐 TypeScript | 📅 2026-09-09 - Open-source, self-hostable automation platform with a no-code visual builder and hundreds of connectors ("pieces"), positioned as a Zapier alternative.
* [Node-RED (⭐23k)](https://github.com/node-red/node-red) ⭐ 23,638 | 🐛 328 | 🌐 JavaScript | 📅 2026-09-09 - Low-code, flow-based programming tool for wiring together hardware devices, APIs, and online services through a browser-based visual editor.
* [Automatisch (⭐13k)](https://github.com/automatisch/automatisch) ⭐ 13,963 | 🐛 287 | 🌐 JavaScript | 📅 2026-02-11 - Open-source business automation tool that connects popular services without sharing your data with third parties.
* [Pipedream (⭐11k)](https://github.com/PipedreamHQ/pipedream) ⭐ 11,682 | 🐛 4,407 | 🌐 JavaScript | 📅 2026-09-09 - Developer-centric integration platform that combines thousands of prebuilt triggers and actions with code-level control in Node.js, Python, Go, and Bash.
...
* [Apache Spark (⭐43k)](https://github.com/apache/spark) ⭐ 43,967 | 🐛 512 | 🌐 Scala | 📅 2026-09-09 - Unified analytics engine whose Structured Streaming API provides scalable, fault-tolerant stream processing on the Spark SQL engine.
* [Apache Flink (⭐26k)](https://github.com/apache/flink) ⭐ 26,324 | 🐛 378 | 🌐 Java | 📅 2026-09-09 - Distributed stream processing framework with stateful computations, exactly-once semantics, and event-time processing at scale.
* [RisingWave (⭐9.2k)](https://github.com/risingwavelabs/risingwave) ⭐ 9,309 | 🐛 1,643 | 🌐 Rust | 📅 2026-09-09 - Postgres-compatible streaming database for incremental, real-time materialized views over event streams.
* [Redpanda Connect (⭐8.7k)](https://github.com/redpanda-data/connect) ⭐ 8,741 | 🐛 341 | 🌐 Go | 📅 2026-09-09 - Declarative stream processor and connector toolkit (formerly Benthos) for transforming and routing data between systems.
* [Apache Beam (⭐8.6k)](https://github.com/apache/beam) ⭐ 8,659 | 🐛 3,964 | 🌐 Java | 📅 2026-09-09 - Unified programming model for batch and streaming pipelines, portable across runners such as Flink, Spark, and Google Cloud Dataflow.
* [Arroyo (⭐5k)](https://github.com/ArroyoSystems/arroyo) ⭐ 5,029 | 🐛 119 | 🌐 Rust | 📅 2026-09-09 - Rust-native stream processing engine that lets users build real-time pipelines with SQL, designed for serverless operation.
* [Numaflow (⭐2.8k)](https://github.com/numaproj/numaflow) ⭐ 2,830 | 🐛 283 | 🌐 Rust | 📅 2026-09-08 - Kubernetes-native, serverless platform for massively parallel stream and data processing, with exactly-once semantics and language-agnostic user code.
* [Bytewax (⭐2k)](https://github.com/bytewax/bytewax) ⭐ 2,049 | 🐛 37 | 🌐 Python | 📅 2026-06-20 - Python stream processing framework built on Timely Dataflow, combining Python's ecosystem with Rust performance.
* [ksqlDB (⭐315)](https://github.com/confluentinc/ksql) ⭐ 315 | 🐛 1,336 | 🌐 Java | 📅 2026-09-09 - Database purpose-built for stream processing applications on Kafka, queried with SQL.
...
* [Svix (⭐3.3k)](https://github.com/svix/svix-webhooks) ⭐ 3,393 | 🐛 58 | 🌐 Rust | 📅 2026-09-09 - Webhook sending service with an open-source server, handling signing, retries, and endpoint management for webhook providers.
* [Convoy (⭐2.8k)](https://github.com/frain-dev/convoy) ⭐ 2,861 | 🐛 44 | 🌐 Go | 📅 2026-09-09 - Open-source webhooks gateway for sending and receiving webhooks with retries, rate limiting, and a management dashboard.
...
* [Apache Airflow (⭐46k)](https://github.com/apache/airflow) ⭐ 46,791 | 🐛 2,130 | 🌐 Python | 📅 2026-09-09 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Conductor (⭐32k)](https://github.com/conductor-oss/conductor) ⭐ 32,195 | 🐛 261 | 🌐 Java | 📅 2026-09-09 - Durable workflow orchestration engine originally built at Netflix, now maintained by the community after the original repository was archived.
* [Kestra (⭐27k)](https://github.com/kestra-io/kestra) ⭐ 28,057 | 🐛 669 | 🌐 Java | 📅 2026-09-09 - Event-driven declarative orchestrator with workflows defined in YAML and hundreds of plugins for data and infrastructure automation.
* [Prefect (⭐23k)](https://github.com/PrefectHQ/prefect) ⭐ 23,807 | 🐛 868 | 🌐 Python | 📅 2026-09-09 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐22k)](https://github.com/temporalio/temporal) ⭐ 22,928 | 🐛 935 | 🌐 Go | 📅 2026-09-09 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Windmill (⭐17k)](https://github.com/windmill-labs/windmill) ⭐ 17,828 | 🐛 851 | 🌐 Rust | 📅 2026-09-09 - Open-source developer platform that turns scripts in Python, TypeScript, Go, and more into workflows, internal UIs, and scheduled jobs.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 16,966 | 🐛 1,279 | 🌐 Go | 📅 2026-09-09 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
* [Dagster (⭐16k)](https://github.com/dagster-io/dagster) ⭐ 16,132 | 🐛 2,595 | 🌐 Python | 📅 2026-09-09 - Data orchestrator with a declarative, asset-based programming model for building and observing data pipelines.
* [Activiti (⭐10k)](https://github.com/Activiti/Activiti) ⭐ 10,532 | 🐛 613 | 🌐 Java | 📅 2026-09-09 - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
* [Flowable (⭐9.5k)](https://github.com/flowable/flowable-engine) ⭐ 9,530 | 🐛 410 | 🌐 Java | 📅 2026-09-04 - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
* [Cadence (⭐9.4k)](https://github.com/uber/cadence) ⭐ 9,434 | 🐛 198 | 🌐 Go | 📅 2026-09-09 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
* [Elsa Core (⭐7.8k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,877 | 🐛 777 | 🌐 C# | 📅 2026-09-09 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
* [StackStorm (⭐6.5k)](https://github.com/StackStorm/st2) ⭐ 6,534 | 🐛 602 | 🌐 Python | 📅 2026-09-02 - Robust automation engine that combines sensors, triggers, and workflows to orchestrate complex IT processes.
* [Inngest (⭐5.7k)](https://github.com/inngest/inngest) ⭐ 5,820 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Event-driven durable execution platform that runs reliable step functions inside your existing services.
* [Azkaban (⭐4.5k)](https://github.com/azkaban/azkaban) ⭐ 4,509 | 🐛 801 | 🌐 Java | 📅 2024-07-03 - Distributed scheduler that simplifies managing job dependencies in large-scale data processing environments.
* [Restate (⭐4.3k)](https://github.com/restatedev/restate) ⭐ 4,401 | 🐛 438 | 🌐 Rust | 📅 2026-09-07 - Durable execution engine for building resilient workflows, event-driven services, and stateful handlers as plain code.
* [Camunda (⭐4.2k)](https://github.com/camunda/camunda) ⭐ 4,272 | 🐛 2,832 | 🌐 Java | 📅 2026-09-09 - Process orchestration platform built on the horizontally scalable Zeebe engine, with full BPMN and DMN support.
* [jBPM (⭐1.7k)](https://github.com/kiegroup/jbpm) ⭐ 1,740 | 🐛 44 | 🌐 Java | 📅 2026-07-01 - Comprehensive toolkit for automating business processes and decisions with robust workflow management capabilities.
* [LittleHorse (⭐397)](https://github.com/littlehorse-enterprises/littlehorse) ⭐ 399 | 🐛 200 | 🌐 Java | 📅 2026-09-09 - High-throughput, low-latency microservice orchestration engine built on Kafka Streams, with SDKs in multiple languages.
* [Bonita (⭐176)](https://github.com/bonitasoft/bonita-engine) ⭐ 176 | 🐛 1 | 🌐 Java | 📅 2026-09-07 - Open-source BPMN engine with a designer interface to build and automate complex business processes.
...
* [OpenAPI (ex.Swagger) (⭐31k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,214 | 🐛 80 | 🌐 Markdown | 📅 2026-09-01 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
* [GraphQL (⭐14k)](https://github.com/graphql/graphql-spec) ⭐ 14,590 | 🐛 196 | 🌐 JavaScript | 📅 2026-09-05 - A sophisticated query language and runtime for building efficient APIs that empowers engineers to retrieve data from existing systems with ease.
...
* [CloudEvents (⭐5.8k)](https://github.com/cloudevents/spec) ⭐ 5,887 | 🐛 15 | 🌐 Python | 📅 2026-09-03 -  A specification for describing event data in common formats to provide interoperability across services, platforms and systems.
* [TypeSpec (⭐5.8k)](https://github.com/microsoft/typespec) ⭐ 5,847 | 🐛 1,073 | 🌐 Java | 📅 2026-09-09 - A highly extensible language for describing API data shapes and protocols, capable of compiling to OpenAPI, JSON Schema, Protobuf, and other formats.
* [AsyncAPI (⭐5.2k)](https://github.com/asyncapi/spec) ⭐ 5,300 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-02 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [Standard Webhooks (⭐1.7k)](https://github.com/standard-webhooks/standard-webhooks) ⭐ 1,742 | 🐛 61 | 🌐 Java | 📅 2026-09-03 - Open source tools and guidelines for sending webhooks easily, securely, and reliably.
* [Arazzo Specification (⭐466)](https://github.com/OAI/Arazzo-Specification) ⭐ 468 | 🐛 67 | 🌐 JavaScript | 📅 2026-09-07 - A standard, programming language-agnostic representation for describing sequences of API calls (workflows) and their dependencies.
...
* [API-Security-Checklist (⭐23k)](https://github.com/shieldfy/API-Security-Checklist) ⭐ 23,312 | 🐛 2 | 📅 2026-07-21 - Best practices about REST API security.
...
* [Protocol Buffers (⭐71k)](https://github.com/protocolbuffers/protobuf) ⭐ 72,013 | 🐛 310 | 🌐 C++ | 📅 2026-09-09 - A language-neutral and platform-neutral serialization mechanism that is designed to be highly efficient and extensible. It supports rich data types and is widely used in distributed systems, such as gRPC and Apache Kafka.
* [FlatBuffers (⭐26k)](https://github.com/google/flatbuffers) ⭐ 26,448 | 🐛 283 | 🌐 C++ | 📅 2026-08-11 - An efficient cross-platform serialization library from Google that allows direct access to serialized data without parsing or unpacking.
* [Apache Arrow (⭐17k)](https://github.com/apache/arrow) ⭐ 17,095 | 🐛 2,588 | 🌐 C++ | 📅 2026-09-09 - Language-agnostic columnar in-memory format for fast data interchange, including the Arrow IPC format and Flight RPC for moving data between systems.
* [Cap'n Proto (⭐13k)](https://github.com/capnproto/capnproto) ⭐ 13,181 | 🐛 324 | 🌐 C++ | 📅 2026-09-08 - An extremely fast data interchange format and RPC system whose zero-copy encoding doubles as both wire format and in-memory representation.
* [Apache Thrift (⭐10k)](https://github.com/apache/thrift) ⭐ 10,957 | 🐛 30 | 🌐 C++ | 📅 2026-09-09 - A serialization and RPC framework originally developed at Facebook that generates cross-language bindings from a single interface definition file.
* [MessagePack (⭐7.4k)](https://github.com/msgpack/msgpack) ⭐ 7,505 | 🐛 95 | 📅 2024-08-10 - An efficient binary serialization format that lets you exchange data among multiple languages like JSON, but smaller and faster.
* [Apache Fory (⭐4.5k)](https://github.com/apache/fory) ⭐ 4,531 | 🐛 71 | 🌐 Java | 📅 2026-09-08 - Fast multi-language serialization framework that uses just-in-time compilation and zero-copy techniques, with a cache-friendly row format. Formerly named Apache Fury.
* [Apache Avro (⭐3.3k)](https://github.com/apache/avro) ⭐ 3,304 | 🐛 235 | 🌐 Java | 📅 2026-09-07 - Data serialization system that provides compact, fast, and efficient serialization of structured data. It supports schema evolution, allows for efficient data compression, and is designed to work well with big data processing frameworks.
...
* [JSON](https://datatracker.ietf.org/doc/html/rfc8259) - A lightweight and easy-to-read data format that is widely used for data exchange. It supports a wide range of data types and is compatible with many programming languages.
  * [NDJSON (⭐847)](https://github.com/ndjson/ndjson-spec) ⭐ 849 | 🐛 17 | 📅 2022-10-20 - A standard for delimiting JSON objects in stream protocols. It allows for efficient processing of large JSON datasets and is widely used in big data processing.
...
* [OpenMessaging (⭐287)](https://github.com/openmessaging/specification) ⭐ 288 | 🐛 5 | 📅 2023-07-26 - A cloud native, vendor-neutral open specification for distributed messaging.
...
* [JSON Schema (⭐5.1k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 5,144 | 🐛 65 | 🌐 JavaScript | 📅 2026-09-04 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/stn1slv/awesome-integration/blob/main/CONTRIBUTING.md) ⭐ 560 | 🐛 1 | 🌐 Markdown | 📅 2026-09-01 first.
