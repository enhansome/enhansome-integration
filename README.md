...
* [LiteLLM (⭐59k)](https://github.com/BerriAI/litellm) ⭐ 59,481 | 🐛 5,186 | 🌐 Python | 📅 2026-09-23 - An LLM gateway that exposes 100+ model providers through a unified OpenAI-compatible API, with spend tracking, fallbacks, and rate limiting.
* [Portkey AI Gateway (⭐13k)](https://github.com/Portkey-AI/gateway) ⭐ 13,068 | 🐛 275 | 🌐 TypeScript | 📅 2026-05-25 - A fast AI gateway that routes to 250+ LLMs with guardrails, caching, retries, and load balancing via a single API.
* [Bifrost (⭐8.2k)](https://github.com/maximhq/bifrost) ⭐ 8,284 | 🐛 1,048 | 🌐 Go | 📅 2026-09-23 - A high-performance AI gateway written in Go that unifies more than 20 model providers behind a single OpenAI-compatible API, with failover, load balancing, semantic caching, and governance.
* [agentgateway (⭐4.9k)](https://github.com/agentgateway/agentgateway) ⭐ 5,006 | 🐛 286 | 🌐 Rust | 📅 2026-09-23 - An open-source data plane for agentic AI connectivity, providing security, observability, and governance for agent-to-tool (MCP) and agent-to-agent (A2A) communication.
* [IBM ContextForge (⭐4.5k)](https://github.com/IBM/mcp-context-forge) ⭐ 4,521 | 🐛 971 | 🌐 Python | 📅 2026-09-23 - An AI gateway, registry, and proxy that federates MCP, A2A, and REST services behind a single endpoint with governance and observability.
* [Envoy AI Gateway (⭐2.1k)](https://github.com/envoyproxy/ai-gateway) ⭐ 2,131 | 🐛 312 | 🌐 Go | 📅 2026-09-21 - An open-source gateway built on Envoy Proxy to manage request traffic from application clients to GenAI services with unified API access and usage limits.
* [Docker MCP Gateway (⭐1.5k)](https://github.com/docker/mcp-gateway) ⭐ 1,581 | 🐛 145 | 🌐 Go | 📅 2026-09-23 - Runs MCP servers as isolated containers with restricted privileges and managed secrets, exposing them to AI clients through one gateway endpoint.
* [MCPJungle (⭐1.2k)](https://github.com/mcpjungle/MCPJungle) ⭐ 1,278 | 🐛 107 | 🌐 Go | 📅 2026-08-02 - A self-hosted MCP gateway and registry that centralises multiple MCP servers behind one endpoint for AI agents.
* [Obot (⭐1k)](https://github.com/obot-platform/obot) ⭐ 1,037 | 🐛 417 | 🌐 Go | 📅 2026-09-22 - An open-source MCP platform that combines server hosting, a registry, a gateway, and a chat client with access control and audit logging.
...
* [WSO2 API Manager (⭐1k)](https://github.com/wso2/product-apim) ⭐ 1,028 | 🐛 651 | 🌐 Java | 📅 2026-09-23 - A fully open-source API platform offering robust governance, flexible deployment, and community-driven innovation.
* [Gravitee.io API Management (⭐455)](https://github.com/gravitee-io/gravitee-api-management) ⭐ 455 | 🐛 103 | 🌐 Java | 📅 2026-09-23 - A lightweight, open-source platform offering flexible API governance, robust security, and straightforward configuration.
...
* [OpenAPI Generator (⭐26k)](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,756 | 🐛 5,739 | 🌐 Java | 📅 2026-09-23 - Automate the creation of API client libraries, server stubs, documentation and config files with this powerful OpenAPI Spec tool.
...
* [Kiota (⭐3.8k)](https://github.com/microsoft/kiota) ⭐ 3,824 | 🐛 230 | 🌐 C# | 📅 2026-09-23 - A command-line generator from Microsoft that turns an OpenAPI description into a lightweight, strongly typed API client in many languages.
* [Spectral (⭐3.2k)](https://github.com/stoplightio/spectral) ⭐ 3,216 | 🐛 222 | 🌐 TypeScript | 📅 2026-09-17 - Detect and fix errors in your JSON/YAML files using this linter tool that supports OpenAPI 3.0 & 2.0 and AsyncAPI.
* [Redocly CLI (⭐1.5k)](https://github.com/Redocly/redocly-cli) ⭐ 1,514 | 🐛 162 | 🌐 TypeScript | 📅 2026-09-23 - Lint, bundle, and preview OpenAPI descriptions with configurable rulesets and plugins.
...
* [oasdiff (⭐1.3k)](https://github.com/oasdiff/oasdiff) ⭐ 1,377 | 🐛 50 | 🌐 Go | 📅 2026-09-21 - Compare OpenAPI specs and detect breaking changes, with changelog generation in multiple output formats.
* [vacuum (⭐1.1k)](https://github.com/daveshanley/vacuum) ⭐ 1,128 | 🐛 38 | 🌐 Go | 📅 2026-09-15 - An ultra-fast OpenAPI linter and quality analysis tool, compatible with Spectral rulesets.
...
* [Swagger UI (⭐29k)](https://github.com/swagger-api/swagger-ui) ⭐ 29,017 | 🐛 1,131 | 🌐 JavaScript | 📅 2026-09-21 - Offers an interactive, in-browser tool for visualizing and testing APIs directly from OpenAPI specifications.
* [Redoc (⭐25k)](https://github.com/Redocly/redoc) ⭐ 25,923 | 🐛 446 | 🌐 TypeScript | 📅 2026-09-22 - Delivers clean, modern documentation with advanced theming, multi-language support, and seamless integration.
* [Scalar (⭐16k)](https://github.com/scalar/scalar) ⭐ 16,176 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-23 - Renders modern, interactive API references from OpenAPI/Swagger documents, with an integrated API client and broad framework integrations.
* [Fern (⭐3.7k)](https://github.com/fern-api/fern) ⭐ 3,782 | 🐛 345 | 🌐 TypeScript | 📅 2026-09-23 - Generates SDKs and interactive API documentation from OpenAPI or its own API definition format.
...
* [Zudoku (⭐595)](https://github.com/zuplo/zudoku) ⭐ 596 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-17 - A customizable framework built on OpenAPI, focused on delivering exceptional developer experiences through quality documentation.
...
* [Traefik API Gateway (⭐64k)](https://github.com/traefik/traefik) ⭐ 64,937 | 🐛 936 | 🌐 Go | 📅 2026-09-23 - Combines Traefik Proxy, a fully declarative application proxy with enterprise-grade access control, distributed security, and premium integrations.
* [Kong API Gateway (⭐44k)](https://github.com/Kong/kong) ⭐ 44,183 | 🐛 208 | 🌐 Lua | 📅 2026-09-23 - A scalable, cloud-native gateway that simplifies API management through extensive plugin support and seamless microservices integration.
* [Apache APISIX (⭐17k)](https://github.com/apache/apisix) ⭐ 17,160 | 🐛 242 | 🌐 Lua | 📅 2026-09-22 - A high-performance, dynamic gateway featuring real-time traffic management and powerful plugin integrations.
* [Tyk API Gateway (⭐10k)](https://github.com/TykTechnologies/tyk) ⭐ 10,830 | 🐛 510 | 🌐 Go | 📅 2026-09-23 - An enterprise-grade, open-source gateway supporting REST, GraphQL, TCP, and gRPC with advanced rate limiting and analytics.
* [Higress (⭐9.4k)](https://github.com/higress-group/higress) ⭐ 9,448 | 🐛 1,154 | 🌐 Go | 📅 2026-09-23 - A next-generation cloud-native gateway based on Envoy and Istio, offering high performance, easy-to-use, and rich plugin extensibility.
* [Apache ShenYu (⭐8.8k)](https://github.com/apache/shenyu) ⭐ 8,839 | 🐛 576 | 🌐 Java | 📅 2026-09-23 - A Java-native gateway excelling in protocol conversion, service proxying, and comprehensive API governance.
...
* [kgateway (⭐5.6k)](https://github.com/kgateway-dev/kgateway) ⭐ 5,691 | 🐛 204 | 🌐 Go | 📅 2026-09-23 - A CNCF Envoy-based, Kubernetes-native API gateway built around the Kubernetes Gateway API, and the successor to the Gloo open-source project.
...
* [Envoy Gateway (⭐3k)](https://github.com/envoyproxy/gateway) ⭐ 3,046 | 🐛 777 | 🌐 Go | 📅 2026-09-23 - CNCF Envoy-based gateway with Gateway API, mTLS, JWT, and other built-ins.
* [KrakenD API Gateway (⭐2.6k)](https://github.com/krakend/krakend-ce) ⭐ 2,686 | 🐛 36 | 🌐 Go | 📅 2026-09-21 - An ultra-high performance gateway with efficient middleware configuration, robust security, and seamless scaling.
...
* API clients
  * [Hoppscotch (⭐80k)](https://github.com/hoppscotch/hoppscotch) ⭐ 80,481 | 🐛 824 | 🌐 TypeScript | 📅 2026-09-23 - A lightweight, web-based API development tool offering real-time testing with an intuitive interface.
  * [Bruno (⭐47k)](https://github.com/usebruno/bruno) ⭐ 47,139 | 🐛 1,850 | 🌐 JavaScript | 📅 2026-09-23 - A fast, offline API client designed for git-friendly workflows and seamless testing.
  * [curl (⭐42k)](https://github.com/curl/curl) ⭐ 42,908 | 🐛 61 | 🌐 C | 📅 2026-09-23 - A versatile command-line tool for data transfer across multiple protocols, essential for quick API testing.
  * [Insomnia (⭐40k)](https://github.com/Kong/insomnia) ⭐ 40,030 | 🐛 899 | 🌐 TypeScript | 📅 2026-09-23 - A cross-platform client that streamlines API debugging and testing for both REST and GraphQL services.
  * [HTTPie (⭐38k)](https://github.com/httpie/httpie) ⭐ 38,570 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - An intuitive CLI HTTP client that simplifies crafting API requests and inspecting responses.
  * [Yaak (⭐19k)](https://github.com/mountain-loop/yaak) ⭐ 19,254 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-23 - A fast, privacy-first desktop API client for REST, GraphQL, WebSocket, Server-Sent Events, and gRPC with offline-first design, built with Tauri and React.
  * [grpcurl (⭐12k)](https://github.com/fullstorydev/grpcurl) ⭐ 12,824 | 🐛 118 | 🌐 Go | 📅 2026-09-02 - A command-line tool for interacting with gRPC servers, enabling inspection and invocation of RPC methods with support for server reflection and protocol buffer files.
  * [posting (⭐12k)](https://github.com/darrenburns/posting) ⭐ 12,443 | 🐛 87 | 🌐 Python | 📅 2026-03-25 - A modern, terminal-based API client designed for efficient and seamless API interactions.
  * [xh (⭐8k)](https://github.com/ducaale/xh) ⭐ 8,090 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - A fast, friendly CLI HTTP client that reimplements HTTPie's design with improved performance, HTTP/2 support, and built-in curl translation.
  * [Requestly (⭐6.7k)](https://github.com/requestly/requestly) ⭐ 6,759 | 🐛 273 | 📅 2026-09-23 - Lightweight Git-Friendly API Client Built for Modern Developers.
  * [gRPC UI (⭐5.9k)](https://github.com/fullstorydev/grpcui) ⭐ 5,923 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-14 - An interactive web-based tool for gRPC APIs, providing a browser-based interface for testing and exploring gRPC services with dynamic form generation.
...
* Contract testing
  ...
  * [Specmatic (⭐397)](https://github.com/specmatic/specmatic) ⭐ 397 | 🐛 79 | 🌐 Kotlin | 📅 2026-09-23 - Turns OpenAPI, AsyncAPI, and gRPC specifications into executable contracts for contract-driven development and testing.
...
* MQ clients
  ...
  * [MQTT Explorer (⭐4k)](https://github.com/thomasnordquist/MQTT-Explorer) ⭐ 4,074 | 🐛 403 | 🌐 TypeScript | 📅 2026-05-08 - A detailed MQTT client delivering structured topic visualization and intuitive debugging.
  * [Service Bus Explorer (⭐2.2k)](https://github.com/paolosalvatori/ServiceBusExplorer) ⭐ 2,217 | 🐛 73 | 🌐 C# | 📅 2026-09-15 - An advanced GUI for Azure Service Bus that enables in-depth testing and seamless management of topics, queues, and subscriptions.
...
* Mocking tools
  * [Mock Service Worker (MSW) (⭐18k)](https://github.com/mswjs/msw) ⭐ 18,218 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-21 - A seamless API mocking library for browser and Node.js that intercepts requests at the network level.
  * [Mockoon (⭐8.4k)](https://github.com/mockoon/mockoon) ⭐ 8,419 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-20 - A user-friendly tool for designing and running mock REST APIs with real-time simulation and easy setup.
  * [WireMock (⭐7.3k)](https://github.com/wiremock/wiremock) ⭐ 7,378 | 🐛 502 | 🌐 Java | 📅 2026-09-23 - A robust and flexible API mocking tool delivering reliable, real-time simulation for comprehensive testing.
  * [Prism (⭐5k)](https://github.com/stoplightio/prism) ⭐ 5,035 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-21 - An open-source HTTP mock server that replicates API behavior for early testing and validation.
  * [MockServer (⭐4.9k)](https://github.com/mock-server/mockserver) ⭐ 4,974 | 🐛 1 | 🌐 Java | 📅 2026-09-23 - A powerful solution for mocking any HTTP/HTTPS-based service, streamlining integration testing.
  * [Hoverfly (⭐2.5k)](https://github.com/SpectoLabs/hoverfly) ⭐ 2,523 | 🐛 34 | 🌐 Go | 📅 2026-09-21 - A lightweight API simulation tool that enables rapid HTTP(S) service virtualization for efficient testing.
  ...
  * [Microcks (⭐2k)](https://github.com/microcks/microcks) ⭐ 2,048 | 🐛 59 | 🌐 Java | 📅 2026-09-22 - A Kubernetes-native tool for API mocking and testing that supports AsyncAPI, OpenAPI, and Postman Collections.
  * [Imposter (⭐415)](https://github.com/outofcoffee/imposter) ⭐ 415 | 🐛 56 | 🌐 Shell | 📅 2026-09-23 - A flexible mock server supporting REST, OpenAPI, SOAP, and more to simulate diverse API behaviors.
...
* Testing tools and frameworks
  * [Grafana k6 (⭐31k)](https://github.com/grafana/k6) ⭐ 31,555 | 🐛 794 | 🌐 Go | 📅 2026-09-23 - Open-source, JS-scriptable load-testing tool for CI/CD.
  * [Hurl (⭐19k)](https://github.com/Orange-OpenSource/hurl) ⭐ 19,213 | 🐛 197 | 🌐 Rust | 📅 2026-09-21 - A command-line tool for running HTTP requests with plain text syntax, excellent for both API testing and CI/CD integration with support for chaining, capturing values, and comprehensive assertions.
  * [Keploy (⭐18k)](https://github.com/keploy/keploy) ⭐ 18,478 | 🐛 746 | 🌐 Go | 📅 2026-09-23 - A developer-centric API and integration testing tool that auto-generates tests and data-mocks from real traffic using eBPF, supporting any language without code changes.
  * [Apache JMeter (⭐9.5k)](https://github.com/apache/jmeter) ⭐ 9,544 | 🐛 981 | 🌐 Java | 📅 2026-09-12 - A feature-rich tool for load testing and performance analysis across diverse web applications and services.
  * [Artillery (⭐9k)](https://github.com/artilleryio/artillery) ⭐ 9,081 | 🐛 486 | 🌐 TypeScript | 📅 2026-09-23 - A complete load testing platform supporting HTTP, WebSocket, Socket.io, gRPC, and more, with cloud-native serverless scaling on AWS Lambda and Fargate.
  * [Karate (⭐8.9k)](https://github.com/karatelabs/karate) ⭐ 8,969 | 🐛 15 | 🌐 Java | 📅 2026-09-23 - A unified testing framework that merges API automation, mocking, and performance testing with simple, expressive syntax.
  ...
  * [Gatling (⭐6.9k)](https://github.com/gatling/gatling) ⭐ 6,958 | 🐛 19 | 🌐 Scala | 📅 2026-09-23 - A powerful load testing framework with a developer-friendly DSL that delivers detailed performance metrics.
  * [Schemathesis (⭐3.6k)](https://github.com/schemathesis/schemathesis) ⭐ 3,622 | 🐛 10 | 🌐 Python | 📅 2026-09-23 - A Python library for property-based testing of API schemas, ensuring reliability through robust edge-case detection.
  ...
  * [Taurus (⭐2.1k)](https://github.com/Blazemeter/taurus) ⭐ 2,113 | 🐛 39 | 🌐 Python | 📅 2026-09-23 - An open-source automation framework that simplifies continuous testing with intuitive configuration and integration support.
...
* [phase4 (⭐238)](https://github.com/phax/phase4) ⭐ 238 | 🐛 7 | 🌐 Java | 📅 2026-09-23 - Embeddable, lightweight Java library implementing the AS4 messaging protocol, including the Peppol and CEF/eDelivery profiles.
...
* [ZEN Engine (⭐2k)](https://github.com/gorules/zen) ⭐ 2,009 | 🐛 42 | 🌐 Rust | 📅 2026-09-23 - A cross-platform, open-source Business Rules Engine written in Rust that executes JSON Decision Models through interconnected graphs of decision tables, functions, and expressions.
* [OpenL Tablets (⭐206)](https://github.com/openl-tablets/openl-tablets) ⭐ 206 | 🐛 17 | 🌐 Java | 📅 2026-09-23 - Flexible open-source decision management system that simplifies defining and executing business rules and decision tables.
...
* [Debezium (⭐13k)](https://github.com/debezium/debezium) ⭐ 13,148 | 🐛 138 | 🌐 Java | 📅 2026-09-23 - Open-source distributed platform for change data capture that turns your existing databases into event streams for real-time data integration.
* [Maxwell's daemon (⭐4.2k)](https://github.com/zendesk/maxwell) ⭐ 4,260 | 🐛 265 | 🌐 Java | 📅 2026-09-23 - An open-source CDC tool for MySQL that reads database binlogs and streams row-level changes as JSON to systems like Kafka, Kinesis, or other destinations.
* [PeerDB (⭐3.2k)](https://github.com/PeerDB-io/peerdb) ⭐ 3,280 | 🐛 208 | 🌐 Go | 📅 2026-09-23 - Postgres-first CDC platform for fast, simple replication from PostgreSQL to data warehouses, queues, and storage.
...
* [Airbyte (⭐22k)](https://github.com/airbytehq/airbyte) ⭐ 22,123 | 🐛 2,489 | 🌐 Python | 📅 2026-09-23 - Flexible, open-source data integration platform that builds ELT pipelines to move data from diverse sources to modern destinations.
* [Apache SeaTunnel (⭐9.6k)](https://github.com/apache/seatunnel) ⭐ 9,675 | 🐛 764 | 🌐 Java | 📅 2026-09-23 - High-performance, distributed data integration platform supporting batch and streaming synchronization across hundreds of connectors.
* [Pentaho Data Integration (⭐8.3k)](https://github.com/pentaho/pentaho-kettle) ⭐ 8,399 | 🐛 76 | 🌐 Java | 📅 2026-09-23 - Intuitive, visual ETL tool that simplifies data ingestion, blending, and cleansing across multiple sources without heavy coding.
* [Apache NiFi (⭐6.2k)](https://github.com/apache/nifi) ⭐ 6,242 | 🐛 33 | 🌐 Java | 📅 2026-09-23 - Automated data integration tool with a visual interface that seamlessly extracts, transforms, and delivers data across systems.
* [dlt (⭐5.8k)](https://github.com/dlt-hub/dlt) ⭐ 5,887 | 🐛 442 | 🌐 Python | 📅 2026-09-23 - Open-source Python library for building data pipelines as code, with schema evolution and incremental loading out of the box.
* [Meltano (⭐2.6k)](https://github.com/meltano/meltano) ⭐ 2,635 | 🐛 146 | 🌐 Python | 📅 2026-09-23 - Declarative, code-first data integration engine that runs Singer taps and targets with version-controlled pipeline configuration.
* [Apache InLong (⭐1.5k)](https://github.com/apache/inlong) ⭐ 1,502 | 🐛 24 | 🌐 Java | 📅 2026-09-16 - One-stop, full-scenario integration framework for massive data that supports data ingestion, synchronization, and subscription with real-time ETL capabilities.
* [Singer (⭐1.3k)](https://github.com/singer-io/getting-started) ⭐ 1,350 | 🐛 29 | 🌐 Makefile | 📅 2025-08-08 - Open-source standard for writing scripts that move data, defining a JSON-based protocol between extraction "taps" and loading "targets".
* [Estuary Flow (⭐978)](https://github.com/estuary/flow) ⭐ 979 | 🐛 254 | 🌐 Rust | 📅 2026-09-23 - Versatile, scalable platform that provides both real-time and batch data integration for ETL and ELT pipelines.
* [Sling (⭐906)](https://github.com/slingdata-io/sling-cli) ⭐ 909 | 🐛 27 | 🌐 Go | 📅 2026-09-23 - Fast ELT command-line tool and Go library for moving data between databases, files, and cloud storage across a wide set of connectors.
* [Conduit (⭐611)](https://github.com/ConduitIO/conduit) ⭐ 611 | 🐛 124 | 🌐 Go | 📅 2026-09-23 - Lightweight data integration tool written in Go that streams data between systems using built-in or standalone connectors, with Kafka Connect compatibility.
...
* [JOLT (⭐1.6k)](https://github.com/bazaarvoice/jolt) ⭐ 1,673 | 🐛 415 | 🌐 Java | 📅 2026-09-23 - Java-based JSON transformation library that uses a specification-driven approach for effortless JSON-to-JSON conversions.
...
* [Kaoto (⭐127)](https://github.com/KaotoIO/kaoto) ⭐ 128 | 🐛 278 | 🌐 TypeScript | 📅 2026-09-23 - Visual data mapper for Apache Camel with a drag-and-drop interface supporting XML, JSON, CSV, and XSLT transformations. Successor to AtlasMap.
...
* [NServiceBus (⭐2.1k)](https://github.com/Particular/NServiceBus) ⭐ 2,171 | 🐛 290 | 🌐 C# | 📅 2026-09-23 - Developer-friendly, .NET-based service bus that simplifies messaging and orchestrates service integration efficiently.
* [WSO2 Integrator: MI (⭐263)](https://github.com/wso2/product-integrator-mi) ⭐ 263 | 🐛 385 | 🌐 Java | 📅 2026-09-22 - The configuration-driven integration runtime of the WSO2 Integrator platform, supporting enterprise integration patterns in centralised and containerised deployments.
...
* [Apache Camel (⭐6.3k)](https://github.com/apache/camel) ⭐ 6,341 | 🐛 70 | 🌐 Java | 📅 2026-09-23 - Integration framework with 300+ connectors for databases, messaging, APIs, cloud services, and enterprise systems. Supports both Spring Boot and Quarkus runtimes, and includes AI agent interoperability via the A2A and MCP protocols.
* [Ballerina (⭐3.8k)](https://github.com/ballerina-platform/ballerina-lang) ⭐ 3,856 | 🐛 1,624 | 🌐 Ballerina | 📅 2026-09-23 - Innovative programming language designed for effortless creation and integration of network services and APIs.
* [Wolverine (⭐2.3k)](https://github.com/JasperFx/wolverine) ⭐ 2,358 | 🐛 45 | 🌐 C# | 📅 2026-09-23 - Low-ceremony messaging and command-bus framework for .NET with built-in durable messaging and transports like RabbitMQ and Kafka.
* [Spring Integration (⭐1.6k)](https://github.com/spring-projects/spring-integration) ⭐ 1,630 | 🐛 92 | 🌐 Java | 📅 2026-09-21 - Extension of the Spring ecosystem that provides out-of-the-box integration capabilities using proven Enterprise Integration Patterns.
...
* [Frank!Framework (⭐168)](https://github.com/frankframework/frankframework) ⭐ 168 | 🐛 236 | 🌐 Java | 📅 2026-09-23 - Low-code Java messaging framework that simplifies system connectivity and data integration through configurable XML setups.
...
* [Camel K (⭐929)](https://github.com/apache/camel-k) ⭐ 929 | 🐛 61 | 🌐 Go | 📅 2026-09-23 - Lightweight Kubernetes-native integration platform built on Apache Camel that runs integration routes directly on Kubernetes and OpenShift as cloud-native serverless services.
...
* [Apache Kafka (⭐33k)](https://github.com/apache/kafka) ⭐ 33,799 | 🐛 583 | 🌐 Java | 📅 2026-09-23 - Distributed, high-throughput system designed for real-time data streaming and fault-tolerant processing.
...
* [Apache RocketMQ (⭐22k)](https://github.com/apache/rocketmq) ⭐ 22,617 | 🐛 698 | 🌐 Java | 📅 2026-09-23 - High-performance distributed messaging platform engineered for low latency and high throughput.
* [NATS (⭐20k)](https://github.com/nats-io/nats-server) ⭐ 20,760 | 🐛 453 | 🌐 Go | 📅 2026-09-23 - Lightweight, high-performance messaging system ideal for microservices and cloud-native architectures.
* [EMQX (⭐16k)](https://github.com/emqx/emqx) ⭐ 16,753 | 🐛 223 | 🌐 Erlang | 📅 2026-09-23 - High-performance MQTT broker built for IoT and industrial applications, ensuring scalable message delivery.
* [Apache Pulsar (⭐15k)](https://github.com/apache/pulsar) ⭐ 15,337 | 🐛 1,748 | 🌐 Java | 📅 2026-09-23 - Versatile pub/sub and streaming platform offering scalable, low-latency messaging for modern applications.
* [RabbitMQ (⭐13k)](https://github.com/rabbitmq/rabbitmq-server) ⭐ 13,871 | 🐛 269 | 🌐 JavaScript | 📅 2026-09-23 - Popular open-source broker implementing AMQP, known for reliability, clustering, and ease-of-use.
* [Redpanda (⭐12k)](https://github.com/redpanda-data/redpanda) ⭐ 12,565 | 🐛 526 | 🌐 C++ | 📅 2026-08-22 - Kafka-compatible streaming platform that eliminates Zookeeper, delivering high performance and low latency.
* [Eclipse Mosquitto (⭐11k)](https://github.com/eclipse-mosquitto/mosquitto) ⭐ 11,219 | 🐛 889 | 🌐 C | 📅 2026-09-03 - Lightweight MQTT broker optimized for low-power devices with robust encryption and authentication.
...
* [AutoMQ (⭐10k)](https://github.com/AutoMQ/automq) ⭐ 10,848 | 🐛 60 | 🌐 Java | 📅 2026-09-23 - Stateless, Kafka-compatible broker that runs on S3-class object storage for elastic scaling and reduced cost.
* [Centrifugo (⭐10k)](https://github.com/centrifugal/centrifugo) ⭐ 10,787 | 🐛 24 | 🌐 Go | 📅 2026-09-20 - Scalable real-time messaging server that minimizes delay in delivering events to online users.
* [Apache Iggy (⭐4.9k)](https://github.com/apache/iggy) ⭐ 4,934 | 🐛 208 | 🌐 Rust | 📅 2026-09-23 - Persistent message streaming platform written in Rust, supporting QUIC, TCP, and HTTP transports with high throughput and low latency.
* [VerneMQ (⭐3.6k)](https://github.com/vernemq/vernemq) ⭐ 3,637 | 🐛 170 | 🌐 Erlang | 📅 2026-09-17 - High-performance distributed MQTT broker designed for scalable and efficient message delivery in modern environments.
* [BlazingMQ (⭐3.2k)](https://github.com/bloomberg/blazingmq) ⭐ 3,214 | 🐛 104 | 🌐 C++ | 📅 2026-09-23 - Distributed message queuing system focused on efficiency and reliability for modern workflow needs.
* [ElasticMQ (⭐2.9k)](https://github.com/softwaremill/elasticmq) ⭐ 2,939 | 🐛 23 | 🌐 Scala | 📅 2026-09-19 - In-memory message queue with an Amazon SQS-compatible interface, offering stand-alone or embedded deployment with optional UI and queue persistence.
* [Magistrala (⭐2.6k)](https://github.com/absmach/magistrala) ⭐ 2,641 | 🐛 229 | 🌐 Go | 📅 2026-09-21 - Distributed, event-driven infrastructure for messaging supporting multiple protocols (HTTP, MQTT, WebSocket, CoAP) with strong security and IoT capabilities.
* [Apache ActiveMQ (⭐2.4k)](https://github.com/apache/activemq) ⭐ 2,461 | 🐛 111 | 🌐 Java | 📅 2026-09-23 - Open-source broker that implements JMS, enabling seamless conversion between synchronous and asynchronous messaging.
...
* [HiveMQ (⭐1.2k)](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,212 | 🐛 28 | 🌐 Java | 📅 2026-09-23 - MQTT broker built for reliable IoT messaging at scale, with an open-source community edition and a rich extension system.
* [Apache ActiveMQ Artemis (⭐1k)](https://github.com/apache/activemq-artemis) ⭐ 1,061 | 🐛 25 | 🌐 Java | 📅 2026-09-23 - A multi-protocol message broker, supporting various industry standard protocols such as AMQP 1.0, MQTT 3.1.1, MQTT 5, and STOMP.
* [LavinMQ (⭐1k)](https://github.com/cloudamqp/lavinmq) ⭐ 1,017 | 🐛 181 | 🌐 Crystal | 📅 2026-09-23 - High-performance message queue server implementing AMQP 0-9-1 and MQTT protocols, built with Crystal for exceptional throughput and minimal resource usage.
...
* [Robot Framework (⭐11k)](https://github.com/robotframework/robotframework) ⭐ 11,908 | 🐛 303 | 🌐 Python | 📅 2026-09-21 - An open-source automation framework with human-friendly keyword syntax that enables both technical and non-technical users to create test scripts and automate business processes cost-effectively, supporting web, API, mobile, and database automation through extensive libraries and integrations.
* [TagUI (⭐6.3k)](https://github.com/aisingapore/TagUI) ⭐ 6,334 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-20 - An open-source RPA tool that democratizes automation through natural language scripting in 20+ human languages, enabling non-programmers to automate web, desktop, and data tasks while integrating AI/ML capabilities via Python and R for intelligent process automation.
* [OpenRPA (⭐3k)](https://github.com/open-rpa/openrpa) ⭐ 3,074 | 🐛 2 | 🌐 C# | 📅 2026-04-15 - Enterprise-grade, open-source robotic process automation suite.
...
* [Confluent Schema Registry (⭐2.4k)](https://github.com/confluentinc/schema-registry) ⭐ 2,465 | 🐛 392 | 🌐 Java | 📅 2026-09-23 - Widely used registry for Kafka, providing a RESTful interface and compatibility checks for Avro, JSON Schema, and Protobuf schemas.
* [Apicurio Registry (⭐936)](https://github.com/Apicurio/apicurio-registry) ⭐ 938 | 🐛 744 | 🌐 Java | 📅 2026-09-23 - Open-source registry for API designs and schemas, supporting Avro, Protobuf, JSON Schema, OpenAPI, and AsyncAPI artifacts with configurable compatibility rules.
* [Karapace (⭐635)](https://github.com/Aiven-Open/karapace) ⭐ 636 | 🐛 95 | 🌐 Python | 📅 2026-09-23 - Open-source, drop-in replacement for Confluent Schema Registry and the Kafka REST API.
...
* [n8n (⭐205k)](https://github.com/n8n-io/n8n) ⭐ 205,773 | 🐛 1,134 | 🌐 TypeScript | 📅 2026-09-23 - Open-source workflow automation tool with 400+ connectors, giving you full control over your data and integrations.
* [Huginn (⭐49k)](https://github.com/huginn/huginn) ⭐ 49,983 | 🐛 696 | 🌐 Ruby | 📅 2026-09-23 - Self-hosted system for building agents that monitor services and act on your behalf, like a hackable version of IFTTT.
* [Activepieces (⭐24k)](https://github.com/activepieces/activepieces) ⭐ 24,695 | 🐛 587 | 🌐 TypeScript | 📅 2026-09-23 - Open-source, self-hostable automation platform with a no-code visual builder and hundreds of connectors ("pieces"), positioned as a Zapier alternative.
* [Node-RED (⭐23k)](https://github.com/node-red/node-red) ⭐ 23,681 | 🐛 350 | 🌐 JavaScript | 📅 2026-09-18 - Low-code, flow-based programming tool for wiring together hardware devices, APIs, and online services through a browser-based visual editor.
* [Automatisch (⭐13k)](https://github.com/automatisch/automatisch) ⭐ 13,980 | 🐛 289 | 🌐 JavaScript | 📅 2026-02-11 - Open-source business automation tool that connects popular services without sharing your data with third parties.
* [Pipedream (⭐11k)](https://github.com/PipedreamHQ/pipedream) ⭐ 11,706 | 🐛 4,449 | 🌐 JavaScript | 📅 2026-09-23 - Developer-centric integration platform that combines thousands of prebuilt triggers and actions with code-level control in Node.js, Python, Go, and Bash.
...
* [Apache Spark (⭐44k)](https://github.com/apache/spark) ⭐ 44,030 | 🐛 583 | 🌐 Scala | 📅 2026-09-23 - Unified analytics engine whose Structured Streaming API provides scalable, fault-tolerant stream processing on the Spark SQL engine.
* [Apache Flink (⭐26k)](https://github.com/apache/flink) ⭐ 26,359 | 🐛 378 | 🌐 Java | 📅 2026-09-23 - Distributed stream processing framework with stateful computations, exactly-once semantics, and event-time processing at scale.
* [RisingWave (⭐9.3k)](https://github.com/risingwavelabs/risingwave) ⭐ 9,342 | 🐛 1,701 | 🌐 Rust | 📅 2026-09-23 - Postgres-compatible streaming database for incremental, real-time materialized views over event streams.
* [Redpanda Connect (⭐8.7k)](https://github.com/redpanda-data/connect) ⭐ 8,763 | 🐛 333 | 🌐 Go | 📅 2026-09-23 - Declarative stream processor and connector toolkit (formerly Benthos) for transforming and routing data between systems.
* [Apache Beam (⭐8.6k)](https://github.com/apache/beam) ⭐ 8,670 | 🐛 3,959 | 🌐 Java | 📅 2026-09-23 - Unified programming model for batch and streaming pipelines, portable across runners such as Flink, Spark, and Google Cloud Dataflow.
* [Arroyo (⭐5k)](https://github.com/ArroyoSystems/arroyo) ⭐ 5,039 | 🐛 125 | 🌐 Rust | 📅 2026-09-23 - Rust-native stream processing engine that lets users build real-time pipelines with SQL, designed for serverless operation.
* [Numaflow (⭐2.8k)](https://github.com/numaproj/numaflow) ⭐ 2,829 | 🐛 288 | 🌐 Rust | 📅 2026-09-23 - Kubernetes-native, serverless platform for massively parallel stream and data processing, with exactly-once semantics and language-agnostic user code.
* [Bytewax (⭐2k)](https://github.com/bytewax/bytewax) ⭐ 2,053 | 🐛 38 | 🌐 Python | 📅 2026-06-20 - Python stream processing framework built on Timely Dataflow, combining Python's ecosystem with Rust performance.
* [ksqlDB (⭐315)](https://github.com/confluentinc/ksql) ⭐ 315 | 🐛 1,331 | 🌐 Java | 📅 2026-09-23 - Database purpose-built for stream processing applications on Kafka, queried with SQL.
...
* [Svix (⭐3.4k)](https://github.com/svix/svix-webhooks) ⭐ 3,418 | 🐛 57 | 🌐 Rust | 📅 2026-09-23 - Webhook sending service with an open-source server, handling signing, retries, and endpoint management for webhook providers.
* [Convoy (⭐2.8k)](https://github.com/frain-dev/convoy) ⭐ 2,872 | 🐛 44 | 🌐 Go | 📅 2026-09-23 - Open-source webhooks gateway for sending and receiving webhooks with retries, rate limiting, and a management dashboard.
...
* [Apache Airflow (⭐46k)](https://github.com/apache/airflow) ⭐ 46,954 | 🐛 2,098 | 🌐 Python | 📅 2026-09-23 - Platform for programmatically creating, scheduling, and monitoring workflows, ideal for managing complex data pipelines.
* [Conductor (⭐32k)](https://github.com/conductor-oss/conductor) ⭐ 32,226 | 🐛 255 | 🌐 Java | 📅 2026-09-23 - Durable workflow orchestration engine originally built at Netflix, now maintained by the community after the original repository was archived.
* [Kestra (⭐28k)](https://github.com/kestra-io/kestra) ⭐ 28,310 | 🐛 685 | 🌐 Java | 📅 2026-09-23 - Event-driven declarative orchestrator with workflows defined in YAML and hundreds of plugins for data and infrastructure automation.
* [Prefect (⭐23k)](https://github.com/PrefectHQ/prefect) ⭐ 23,909 | 🐛 847 | 🌐 Python | 📅 2026-09-23 - Modern, developer-friendly orchestration tool optimized for data pipelines and complex workflows.
* [Temporal (⭐23k)](https://github.com/temporalio/temporal) ⭐ 23,260 | 🐛 996 | 🌐 Go | 📅 2026-09-23 - Open-source workflow-as-code platform designed for building reliable, scalable, and fault-tolerant applications.
* [Windmill (⭐17k)](https://github.com/windmill-labs/windmill) ⭐ 18,017 | 🐛 873 | 🌐 Rust | 📅 2026-09-23 - Open-source developer platform that turns scripts in Python, TypeScript, Go, and more into workflows, internal UIs, and scheduled jobs.
* [Argo Workflows (⭐16k)](https://github.com/argoproj/argo-workflows) ⭐ 17,000 | 🐛 1,291 | 🌐 Go | 📅 2026-09-23 - Container-native workflow engine designed for orchestrating parallel jobs in Kubernetes-based, cloud-native environments.
* [Dagster (⭐16k)](https://github.com/dagster-io/dagster) ⭐ 16,197 | 🐛 2,569 | 🌐 Python | 📅 2026-09-23 - Data orchestrator with a declarative, asset-based programming model for building and observing data pipelines.
* [Activiti (⭐10k)](https://github.com/Activiti/Activiti) ⭐ 10,540 | 🐛 599 | 🌐 Java | 📅 2026-09-23 - Lightweight, Java-centric BPMN engine that efficiently executes business workflows with a focus on simplicity.
* [Flowable (⭐9.5k)](https://github.com/flowable/flowable-engine) ⭐ 9,554 | 🐛 412 | 🌐 Java | 📅 2026-09-17 - Compact, efficient set of open-source engines for automating and scaling enterprise workflows.
* [Cadence (⭐9.4k)](https://github.com/uber/cadence) ⭐ 9,448 | 🐛 193 | 🌐 Go | 📅 2026-09-23 - Fault-tolerant, stateful platform that reliably orchestrates long-running workflows and complex applications.
* [Elsa Core (⭐7.8k)](https://github.com/elsa-workflows/elsa-core) ⭐ 7,886 | 🐛 841 | 🌐 C# | 📅 2026-09-23 - .NET Core library that integrates seamlessly into any application to execute and manage workflows.
* [StackStorm (⭐6.5k)](https://github.com/StackStorm/st2) ⭐ 6,538 | 🐛 603 | 🌐 Python | 📅 2026-09-02 - Robust automation engine that combines sensors, triggers, and workflows to orchestrate complex IT processes.
* [Inngest (⭐5.8k)](https://github.com/inngest/inngest) ⭐ 5,878 | 🐛 236 | 🌐 Go | 📅 2026-09-23 - Event-driven durable execution platform that runs reliable step functions inside your existing services.
...
* [Restate (⭐4.4k)](https://github.com/restatedev/restate) ⭐ 4,465 | 🐛 463 | 🌐 Rust | 📅 2026-09-23 - Durable execution engine for building resilient workflows, event-driven services, and stateful handlers as plain code.
* [Camunda (⭐4.2k)](https://github.com/camunda/camunda) ⭐ 4,291 | 🐛 2,829 | 🌐 Java | 📅 2026-09-23 - Process orchestration platform built on the horizontally scalable Zeebe engine, with full BPMN and DMN support.
...
* [LittleHorse (⭐399)](https://github.com/littlehorse-enterprises/littlehorse) ⭐ 401 | 🐛 211 | 🌐 Java | 📅 2026-09-23 - High-throughput, low-latency microservice orchestration engine built on Kafka Streams, with SDKs in multiple languages.
* [Bonita (⭐176)](https://github.com/bonitasoft/bonita-engine) ⭐ 176 | 🐛 1 | 🌐 Java | 📅 2026-09-23 - Open-source BPMN engine with a designer interface to build and automate complex business processes.
...
* [OpenAPI (ex.Swagger) (⭐31k)](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,231 | 🐛 79 | 🌐 Markdown | 📅 2026-09-22 - A language-agnostic specification for creating RESTful APIs that enables both humans and machines to understand the capabilities of a service without the need for source code or documentation.
* [GraphQL (⭐14k)](https://github.com/graphql/graphql-spec) ⭐ 14,596 | 🐛 191 | 🌐 JavaScript | 📅 2026-09-17 - A sophisticated query language and runtime for building efficient APIs that empowers engineers to retrieve data from existing systems with ease.
...
* [TypeSpec (⭐5.8k)](https://github.com/microsoft/typespec) ⭐ 5,869 | 🐛 1,057 | 🌐 Java | 📅 2026-09-23 - A highly extensible language for describing API data shapes and protocols, capable of compiling to OpenAPI, JSON Schema, Protobuf, and other formats.
* [AsyncAPI (⭐5.3k)](https://github.com/asyncapi/spec) ⭐ 5,311 | 🐛 43 | 🌐 JavaScript | 📅 2026-09-13 - An essential tool for developing Event-Driven Architectures (EDA) and enables engineers to build a better tooling ecosystem.
...
* [Standard Webhooks (⭐1.7k)](https://github.com/standard-webhooks/standard-webhooks) ⭐ 1,751 | 🐛 62 | 🌐 Java | 📅 2026-09-17 - Open source tools and guidelines for sending webhooks easily, securely, and reliably.
...
* [Microsoft REST API Guidelines (⭐23k)](https://github.com/microsoft/api-guidelines) ⭐ 23,333 | 🐛 180 | 📅 2026-08-05 - Microsoft's company-wide guidelines for designing consistent REST APIs, including a Microsoft Graph-specific addendum.
...
* [Protocol Buffers (⭐72k)](https://github.com/protocolbuffers/protobuf) ⭐ 72,061 | 🐛 489 | 🌐 C++ | 📅 2026-09-23 - A language-neutral and platform-neutral serialization mechanism that is designed to be highly efficient and extensible. It supports rich data types and is widely used in distributed systems, such as gRPC and Apache Kafka.
* [FlatBuffers (⭐26k)](https://github.com/google/flatbuffers) ⭐ 26,493 | 🐛 304 | 🌐 C++ | 📅 2026-09-14 - An efficient cross-platform serialization library from Google that allows direct access to serialized data without parsing or unpacking.
* [Apache Arrow (⭐17k)](https://github.com/apache/arrow) ⭐ 17,153 | 🐛 2,537 | 🌐 C++ | 📅 2026-09-23 - Language-agnostic columnar in-memory format for fast data interchange, including the Arrow IPC format and Flight RPC for moving data between systems.
* [Cap'n Proto (⭐13k)](https://github.com/capnproto/capnproto) ⭐ 13,189 | 🐛 326 | 🌐 C++ | 📅 2026-09-23 - An extremely fast data interchange format and RPC system whose zero-copy encoding doubles as both wire format and in-memory representation.
* [Apache Thrift (⭐10k)](https://github.com/apache/thrift) ⭐ 10,960 | 🐛 25 | 🌐 C++ | 📅 2026-09-23 - A serialization and RPC framework originally developed at Facebook that generates cross-language bindings from a single interface definition file.
...
* [Apache Fory (⭐4.5k)](https://github.com/apache/fory) ⭐ 4,557 | 🐛 56 | 🌐 Java | 📅 2026-09-23 - Fast multi-language serialization framework that uses just-in-time compilation and zero-copy techniques, with a cache-friendly row format. Formerly named Apache Fury.
...
* [JSON Schema (⭐5.1k)](https://github.com/json-schema-org/json-schema-spec) ⭐ 5,164 | 🐛 65 | 🌐 JavaScript | 📅 2026-09-04 - A powerful tool for validating the structure of JSON data. JSON Schema enables developers to ensure that JSON data conforms to a specific structure, making it easier to process and manipulate.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/stn1slv/awesome-integration/blob/main/CONTRIBUTING.md) ⭐ 564 | 🐛 1 | 🌐 Markdown | 📅 2026-09-21 first.
